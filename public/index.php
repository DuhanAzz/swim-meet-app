...
<body class="bg-slate-50 text-slate-800">
            ...
            <div class="text-white max-w-5xl">
                ...
                <div class="mb-12 w-full md:w-3/4 bg-yellow-400 text-slate-900 px-1 py-1 rounded font-bold overflow-hidden shadow-2xl border-l-8 border-slate-900 transform -skew-x-6">
                    <div class="flex items-center gap-0 bg-yellow-400 skew-x-6">
                        ...
                        <div class="flex-1 overflow-hidden py-2"><marquee class="text-xs md:text-sm uppercase tracking-wide font-black" scrollamount="6"><?= htmlspecialchars($runningText) ?></marquee></div>
                    </div>
                </div>
                <?php endif; ?>

                <div class="flex flex-wrap gap-6 mt-10">
                    <a href="register.php" class="bg-blue-600 px-12 py-5 rounded-2xl font-black uppercase text-base shadow-2xl hover:bg-blue-700 transition tracking-widest">Mulai Daftar</a>
    ...
    <footer class="bg-[#0F172A] text-white pt-32 pb-16 border-t-4 border-blue-600 text-center">
