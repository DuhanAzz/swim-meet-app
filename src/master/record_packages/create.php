        ...
        <form action="process_aggregate.php" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div id="section-csv" class="p-6 hidden">
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-slate-300 border-dashed rounded-2xl cursor-pointer bg-slate-50 hover:bg-slate-100 hover:border-blue-400 transition">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p class="mb-2 text-sm text-slate-500 font-bold"><span class="font-black text-blue-600">Klik untuk upload</span> atau drag and drop</p>
