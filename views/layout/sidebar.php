...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-50 w-64 h-screen transition-transform -translate-x-full bg-[#0F172A] sm:translate-x-0 shadow-2xl flex flex-col border-r border-slate-800" aria-label="Sidebar">
   ...
   <div class="flex-1 overflow-y-auto py-6 space-y-1 custom-scrollbar">
      ...
      <?php if($role == 'master'): ?>
         ...
         <a href="<?= BASE_URL ?>/src/master/users/index.php?role=admin" class="<?= (strpos($req,"role=admin")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-center mr-3 text-lg">👔</span> 
            <span class="font-bold text-[11px] tracking-widest uppercase">Admin EO</span>
         </a>
         
         <a href="<?= BASE_URL ?>/src/master/users/index.php?role=user" class="<?= (strpos($req,"role=user")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-center mr-3 text-lg">🏊</span> 
            <span class="font-bold text-[11px] tracking-widest uppercase">User Klub</span>
         </a>

         <a href="<?= BASE_URL ?>/src/master/swimmers/index.php" class="<?= (strpos($req,"master/swimmers/index")!==false) ? $activeLink : $baseLink ?>">
         ...
         <a href="<?= BASE_URL ?>/src/master/swimmers/history_transfer.php" class="<?= (strpos($req,"history_transfer")!==false) ? $activeLink : $baseLink ?>">
         ...
         <a href="<?= BASE_URL ?>/src/master/maintenance/data_cleanup.php" class="<?= (strpos($req,"maintenance")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-center mr-3 text-lg">🧹</span> 
            <span class="font-bold text-[11px] tracking-widest uppercase">Maintenance</span>
         </a>
         <a href="<?= BASE_URL ?>/src/master/maintenance/system_health.php" class="<?= (strpos($req,"system_health")!==false) ? $activeLink : $baseLink ?>">
             <span class="w-6 text-center mr-3 text-lg">🛡️</span> 
             <span class="font-bold text-[11px] tracking-widest uppercase">System Health</span>
         </a>
         <a href="<?= BASE_URL ?>/src/master/finance/revenue.php" class="<?= (strpos($req,"finance")!==false) ? $activeLink : $baseLink ?>">
             <span class="w-6 text-center mr-3 text-lg">💰</span> 
         ...
         <a href="<?= BASE_URL ?>/src/master/settings/public_page.php" class="<?= (strpos($req,"public_page")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-center mr-3 text-lg">⚙️</span> 
            <span class="font-bold text-[11px] tracking-widest uppercase">Landing Page</span>
         </a>
         <a href="<?= BASE_URL ?>/src/master/settings/global_config.php" class="<?= (strpos($req,"global_config")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-center mr-3 text-lg">⚙️</span> 
         ...
         <a href="<?= BASE_URL ?>/src/master/settings/dq_rules.php" class="<?= (strpos($req,"dq_rules")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-center mr-3 text-lg">⚖️</span> 
      ...
      <?php if($role == 'admin'): ?>
         ...
         <a href="<?= BASE_URL ?>/src/admin/settings/event_profile.php" class="<?= (strpos($req,"event_profile")!==false) ? $activeLink : $baseLink ?>">
         ...
         <a href="<?= BASE_URL ?>/src/events/index.php" class="<?= (strpos($req,"events/index")!==false) ? $activeLink : $baseLink ?>">
         ...
         <a href="<?= BASE_URL ?>/src/admin/entries/index.php" class="<?= (strpos($req,"entries")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-xl mr-3 text-center opacity-80">📋</span>
            <span class="font-bold text-[11px] tracking-widest uppercase">Verifikasi & Entries</span>
         </a>

         <a href="<?= BASE_URL ?>/src/admin/seeding/index.php" class="<?= (strpos($req,"seeding/index")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-xl mr-3 text-center opacity-80">⚡</span>
         ...
         <a href="<?= BASE_URL ?>/src/admin/seeding/final.php" class="<?= (strpos($req,"seeding/final")!==false) ? $activeLink : $baseLink ?> text-orange-400">
            <span class="w-6 text-xl mr-3 text-center opacity-80 group-hover:scale-110 transition">🏆</span> 
         ...
         <a href="<?= BASE_URL ?>/src/admin/results/index.php" class="<?= (strpos($req,"results/index")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-xl mr-3 text-center opacity-80">⏱️</span>
            <span class="font-bold text-[11px] tracking-widest uppercase">Input Hasil</span>
         </a>

         <a href="<?= BASE_URL ?>/src/admin/results/publish_result.php" class="<?= (strpos($req,"publish_result")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-xl mr-3 text-center opacity-80">📢</span>
            <span class="font-bold text-[11px] tracking-widest uppercase">Publikasi Hasil</span>
         </a>

         <a href="<?= BASE_URL ?>/src/admin/results/medal_tally.php" class="<?= (strpos($req,"medal_tally")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-xl mr-3 text-center opacity-80">🥇</span>
            <span class="font-bold text-[11px] tracking-widest uppercase">Rekap Medali</span>
         </a>

         <a href="<?= BASE_URL ?>/src/admin/results/best_swimmer.php" class="<?= (strpos($req,"best_swimmer")!==false) ? $activeLink : $baseLink ?>">
            <span class="w-6 text-xl mr-3 text-center opacity-80">🏆</span>
