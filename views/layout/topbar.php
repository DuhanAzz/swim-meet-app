...
if ($uid > 0) {
    ...
    if ($userData && !empty($userData['photo'])) {
        ...
        $displayImage = "/swim-meet/public/" . $userData['photo'] . "?t=" . time();
        ...
        if ($clubData) {
            ...
            if (!empty($clubData['logo'])) {
                ...
                $displayImage = "/swim-meet/public/" . $clubData['logo'] . "?t=" . time();
          ...
          <div class="relative">
              ...
              <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-xl shadow-xl w-56 border border-slate-100" id="dropdown-user">
                ...
                <ul class="py-2" role="none">
                  ...
                  <li><a href="/swim-meet/public/profile_edit.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 font-medium flex items-center gap-2"><span>👤</span> Edit Profil</a></li>

                  <li><a href="/swim-meet/public/change_password.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 font-medium flex items-center gap-2"><span>🔒</span> Ubah Password</a></li>

                  <div class="border-t border-gray-100 my-1"></div>

                  <li><a href="/swim-meet/public/logout.php" class="block px-4 py-2 text-sm text-red-600 hover:bg-red-50 font-bold flex items-center gap-2"><span>🚪</span> Logout</a></li>
